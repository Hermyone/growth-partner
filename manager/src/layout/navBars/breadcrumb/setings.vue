	...
	<div class="layout-breadcrumb-seting">
		...
		>
			<el-scrollbar class="layout-breadcrumb-seting-bar">
				...
				<!-- 顶栏设置 -->
				<el-divider content-position="left" v-show="getThemeConfig.isDebug">{{ $t('message.layout.twoTopTitle') }}</el-divider>
				<div class="layout-breadcrumb-seting-bar-flex">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt10" v-show="getThemeConfig.isDebug">
				...
				<!-- 菜单设置 -->
				<el-divider content-position="left" v-show="getThemeConfig.isDebug">{{ $t('message.layout.twoMenuTitle') }}</el-divider>
				<div class="layout-breadcrumb-seting-bar-flex" >
				...
				<div class="layout-breadcrumb-seting-bar-flex mt14" v-show="getThemeConfig.isDebug">
				...
				<!-- 分栏设置 -->
				<el-divider content-position="left" v-show="getThemeConfig.isDebug" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">{{
				...
				<div class="layout-breadcrumb-seting-bar-flex mt14" v-show="getThemeConfig.isDebug" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
				...
				<div class="layout-breadcrumb-seting-bar-flex" v-show="getThemeConfig.isDebug" :style="{ opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1 }">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt15" v-show="getThemeConfig.isDebug">
				...
				<div class="layout-breadcrumb-seting-bar-flex mt14">
					<div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.layout.lockPassword') }}</div>
					<div class="layout-breadcrumb-seting-bar-flex-value">
						<el-input v-model="getThemeConfig.lockPassword" size="default" style="width: 100px" show-password></el-input>
					</div>
				</div>
...
<!--				</div>-->
<!--				<div class="layout-breadcrumb-seting-bar-flex mt15" v-show="getThemeConfig.isDebug">-->
<!--					<div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.user.menuSearch') }}</div>-->
<!--					<div class="layout-breadcrumb-seting-bar-flex-value">-->
<!--						<el-switch v-model="getThemeConfig.searchActionVisible" size="small" @change="setLocalThemeConfig"></el-switch>-->
<!--					</div>-->
<!--				</div>-->
<!--				<div class="layout-breadcrumb-seting-bar-flex mt15" v-show="getThemeConfig.isDebug">-->
<!--					<div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.user.message') }}</div>-->
<!--					<div class="layout-breadcrumb-seting-bar-flex-value">-->
<!--						<el-switch v-model="getThemeConfig.noticeActionVisible" size="small" @change="setLocalThemeConfig"></el-switch>-->
<!--					</div>-->
<!--				</div>-->
<!--				<div class="layout-breadcrumb-seting-bar-flex mt15" v-show="getThemeConfig.isDebug">-->
<!--					<div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.user.componentSize') }}</div>-->
<!--					<div class="layout-breadcrumb-seting-bar-flex-value">-->
<!--						<el-switch v-model="getThemeConfig.fontActionVisible" size="small" @change="setLocalThemeConfig"></el-switch>-->
<!--					</div>-->
<!--				</div>-->
<!--				<div class="layout-breadcrumb-seting-bar-flex mt15" v-show="getThemeConfig.isDebug">-->
<!--					<div class="layout-breadcrumb-seting-bar-flex-label">{{ $t('message.user.langSwitching') }}</div>-->
<!--					<div class="layout-breadcrumb-seting-bar-flex-value">-->
<!--						<el-switch v-model="getThemeConfig.langActionVisible" size="small" @change="setLocalThemeConfig"></el-switch>-->
<!--					</div>-->
<!--				</div>-->
<!--				<div class="layout-breadcrumb-seting-bar-flex mt15" v-show="getThemeConfig.isDebug">-->
...
<!--					<div class="layout-breadcrumb-seting-bar-flex-value">-->
<!--						<el-input v-model="getThemeConfig.wartermarkText" size="default" style="width: 100px" @input="onWartermarkTextInput($event)"></el-input>-->
<!--					</div>-->
<!--				</div>-->
...
<!--						>-->
<!--							<el-option label="简体中文" value="zh-cn" :disabled="disabledI18n === 'zh-cn'"></el-option>-->
<!--							<el-option label="English" value="en" :disabled="disabledI18n === 'en'"></el-option>-->
<!--							<el-option label="繁體中文" value="zh-tw" :disabled="disabledI18n === 'zh-tw'"></el-option>-->
<!--						</el-select>-->
<!--					</div>-->
<!--				</div>-->
				<div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }">
					...
					<div class="layout-breadcrumb-seting-bar-flex-value">
						...
						>
							...
							<el-option label="箭头" value="columns-arrow"></el-option>
						</el-select>
					</div>
				</div>
					...
					<div class="layout-drawer-content-item" @click="onSetLayout('defaults')">
						<section class="el-container el-circular" :class="{ 'drawer-layout-active': getThemeConfig.layout === 'defaults' }">
							...
							<section class="el-container is-vertical">
								<header class="el-header" style="height: 10px; padding: 0 5px;"></header>
				...
				<div class="copy-config">
					<el-alert :title="$t('message.layout.tipText')" type="warning" :closable="false" v-show="getThemeConfig.isDebug"> </el-alert>
					<el-button size="default" class="copy-config-btn" type="primary" ref="copyConfigBtnRef" @click="onCopyConfigClick" v-show="getThemeConfig.isDebug">
						<el-icon class="mr5">
							<ele-CopyDocument />
						</el-icon>
					...
					<el-button size="default" class="copy-config-btn-reset" type="warning" @click="onClearCacheClick">
						{{ $t('message.layout.clearCache') }}
					</el-button>
				</div>
			</el-scrollbar>
		</el-drawer>
	...
	setup() {
		...
		onMounted(() => {
			nextTick(() => {
				...
				proxy.mittBus.on('layoutMobileResize', (res: LayoutMobileResize) => {
					getThemeConfig.value.layout = res.layout;
					getThemeConfig.value.isDrawer = false;
					initLayoutChangeFun();
					state.isMobile = common.isMobile();
				});
				setTimeout(() => {
					// 默认样式
					onColorPickerChange();
