<template>
	<el-dialog :title="(ruleForm.userId !== 0 ? '修改' : '添加') + '用户'" v-model="isShowDialog" width="769px" :close-on-click-modal="false">
		<el-form ref="formRef" :model="ruleForm" :rules="rules" size="default" label-width="90px">
			<el-row :gutter="20">
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb15" v-if="ruleForm.userId === 0">
				...
				<el-col :span="24" class="mb15">
					<el-form-item label="用户类型">
						<el-radio-group v-model="ruleForm.isAdmin">
							<el-radio :value="1">后台管理员</el-radio>
		...
		<template #footer>
			<span class="dialog-footer">
				...
				<el-button type="primary" @click="onSubmit" class="dialog-footer-button">{{ ruleForm.userId !== 0 ? '修改' : '添加' }}</el-button>
			</span>
		</template>
	</el-dialog>
</template>
