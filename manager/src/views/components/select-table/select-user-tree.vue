...
<template>
    ...
    >
        ...
        <template #aside>
            <el-scrollbar class="select-dept">
                <el-tree
                        ref="treeRef"
                        node-key="deptId"
        ...
        <el-table-column prop="dept.deptName" label="部门" width="100" show-overflow-tooltip></el-table-column>
        <el-table-column prop="roleInfo" label="角色" width="100" show-overflow-tooltip>
            <template #default="{row}">
